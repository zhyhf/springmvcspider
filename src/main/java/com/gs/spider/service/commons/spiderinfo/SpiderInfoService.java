...
public class SpiderInfoService {
    ...
    public SpiderInfoService setSpiderInfoDAO(SpiderInfoDAO spiderInfoDAO){
        this.spiderInfoDAO = spiderInfoDAO;
        return this;
    }

    public SpiderInfoService setResultBundleBuilder(ResultBundleBuilder bundleBuilder){
...
//          */
//    public ResultBundle<String> index(SpiderInfo spiderInfo) {
//        ResultBundle<String> resultBundle=new ResultBundle<String>();
//        resultBundle.setTraceId("traceId");
//        resultBundle.setSuccess(true);
//        resultBundle.setResult("11111");
//        return resultBundle;
//    }
}
